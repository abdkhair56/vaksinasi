                      ...
                      <div class="card text-center">
                        <div class="card-content">
                          <div class="card-body py-1">
                            ...
                            <div class="text-muted line-ellipsis">Shortlisted Candidate</div>
                            <h3 class="mb-0">7</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card text-center">
                        <div class="card-content">
                          <div class="card-body py-1">
                            ...
                            <div class="text-muted line-ellipsis">Already interviewed</div>
                            <h3 class="mb-0">8</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card text-center">
                        <div class="card-content">
                          <div class="card-body py-1">
                            ...
                            <div class="text-muted line-ellipsis">Total Applications</div>
                            <h3 class="mb-0">56</h3>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card text-center">
                        <div class="card-content">
                          <div class="card-body py-1">
                            ...
                            <div class="text-muted line-ellipsis">Total Attendees</div>
                            <h3 class="mb-0">9</h3>
                          </div>
                        </div>
                      </div>
