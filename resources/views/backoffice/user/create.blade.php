		...
		<div class="content-header row">
			<div class="content-header-left col-12 mb-2 mt-1">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h5 class="content-header-title float-left pr-1 mb-0">Create Users</h5>
										...
										<div class="row">
											...
											<div class="col-12">
												<div class="form-group">
													...
													<input type="email" id="email" class="form-control" name="email" placeholder="abd@email.com" value="{{@old('email')}}">
													@error('email')
								                        <div class="alert bg-rgba-warning alert-dismissible mb-2" role="alert">
											              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
											                <span aria-hidden="true">×</span>
